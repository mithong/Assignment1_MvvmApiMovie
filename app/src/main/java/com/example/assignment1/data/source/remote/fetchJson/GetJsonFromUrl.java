...
public class GetJsonFromUrl extends AsyncTask<String, Void, String> {
    ...
    private final OnFetchDataJsonListener<ArrayList<Movie>> listener;
    private final String keyEntity;

    public GetJsonFromUrl(OnFetchDataJsonListener<ArrayList<Movie>> listener, String keyEntity) {
    ...
    protected void onPostExecute(String s) {
        ...
        if (s != null && !s.isEmpty()) {
            try {
                ...
                listener.onSuccess((new ParseDataWithJson().parseJsonToData(jsonObject, keyEntity)));
